...
const projects = [
  ...
  },
  {
    ...
    description:
      "Exclusive beachfront properties with private access to pristine beaches. These luxurious villas offer the perfect blend of indoor and outdoor living with direct beach access and panoramic ocean views.",
    status: "Coming Soon",
    price: "$3,800,000",
    bedrooms: 4,
    bathrooms: 3.5,
  ...
  },
  {
    ...
    description:
      "Premium mountain homes with panoramic views and ski-in/ski-out access. Experience luxury mountain living with direct access to world-class ski slopes and breathtaking mountain vistas.",
    status: "Pre-selling",
    price: "$4,200,000",
    bedrooms: 5,
    bathrooms: 4.5,
